	...
	tests := []struct {
		...
		// STOKES: Test with address creation from public key instead of hardcoded addresses
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixStokes)
			},
		...
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixStokesTest)
			},
			passedPrefix:   util.Bech32PrefixStokesTest,
			expectedPrefix: util.Bech32PrefixStokesTest,
		},
		...
		// ECDSA P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixStokes)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixStokes,
		},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixStokes)
			},
			passedPrefix:   util.Bech32PrefixStokes,
			expectedPrefix: util.Bech32PrefixStokes,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixStokes)
			},
			passedPrefix:   util.Bech32PrefixStokes,
			expectedPrefix: util.Bech32PrefixStokes,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixStokesTest)
			},
			passedPrefix:   util.Bech32PrefixStokesTest,
			expectedPrefix: util.Bech32PrefixStokesTest,
		},
