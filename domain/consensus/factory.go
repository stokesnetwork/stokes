...
import (
	...
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/blockwindowheapslicestore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/daawindowstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/stokesnetwork/stokes/domain/consensus/model"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/stokesnetwork/stokes/domain/consensus/processes/parentsmanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/pruningproofmanager"
	...
	consensusdatabase "github.com/stokesnetwork/stokes/domain/consensus/database"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/acceptancedatastore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/blockheaderstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/blockrelationstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/blockstatusstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/blockstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/consensusstatestore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/daablocksstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/finalitystore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/multisetstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/pruningstore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/stokesnetwork/stokes/domain/consensus/datastructures/utxodiffstore"
	"github.com/stokesnetwork/stokes/domain/consensus/model/externalapi"
	"github.com/stokesnetwork/stokes/domain/consensus/model/testapi"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/blockbuilder"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/blockprocessor"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/blockvalidator"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/coinbasemanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/consensusstatemanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/dagtopologymanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/dagtraversalmanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/difficultymanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/finalitymanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/ghostdagmanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/headersselectedtipmanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/mergedepthmanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/pastmediantimemanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/pruningmanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/reachabilitymanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/syncmanager"
	"github.com/stokesnetwork/stokes/domain/consensus/processes/transactionvalidator"
...
func (f *factory) NewConsensus(config *Config, db infrastructuredatabase.Database, dbPrefix *prefix.Prefix,
	...
	coinbaseManager := coinbasemanager.New(
		...
		config.HalvingIntervalDaaScore, // STOKES: Added halving interval parameter
